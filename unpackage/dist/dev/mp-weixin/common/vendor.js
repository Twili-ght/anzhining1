...
function initRuntimeSocketService() {
  const hosts = "192.168.31.18,192.168.237.1,192.168.85.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_XEod3x";
...
var define_process_env_UNI_SECURE_NETWORK_CONFIG_default = [{ provider: "aliyun", spaceId: "mp-cc351170-0b43-4dc1-a3e2-66ee8dae8ac4", config: { accessControl: { enable: false, function: {} } } }];
function t(e2) {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.31.18","192.168.237.1","192.168.85.1"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"anzhining","spaceId":"mp-cc351170-0b43-4dc1-a3e2-66ee8dae8ac4","clientSecret":"fHpO9UkT05O72cHzHlG8Ng==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__9E39192";
} catch (e2) {
